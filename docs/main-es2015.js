...
let ModuleAboutwebsparksComponent = class ModuleAboutwebsparksComponent {
};
...
let ModuleBannerComponent = class ModuleBannerComponent {
    constructor(baseUrl = '/') {
...
ModuleBannerComponent.ctorParameters = () => [
...
let ModuleContactformComponent = class ModuleContactformComponent {
};
...
let ModuleContactinfoComponent = class ModuleContactinfoComponent {
};
...
let ModuleContactusnowComponent = class ModuleContactusnowComponent {
};
...
let ModuleCorporatesocialresponsibilityComponent = class ModuleCorporatesocialresponsibilityComponent {
};
...
let ModuleOurcultureComponent = class ModuleOurcultureComponent {
};
...
let ModuleOurservicesComponent = class ModuleOurservicesComponent {
};
...
let ModuleRecentprojectsComponent = class ModuleRecentprojectsComponent {
};
...
let ModuleWhywebsparksComponent = class ModuleWhywebsparksComponent {
};
...
let PageAboutComponent = class PageAboutComponent {
};
...
let PageCareersComponent = class PageCareersComponent {
};
...
let PageContactComponent = class PageContactComponent {
};
...
let PagePortfolioComponent = class PagePortfolioComponent {
};
...
let PageServicedetailComponent = class PageServicedetailComponent {
    getHTML() {
...
let PageServicesComponent = class PageServicesComponent {
};
...
let SharedFooterComponent = class SharedFooterComponent {
};
...
let SharedHeaderComponent = class SharedHeaderComponent {
    getClass() {
...
let SharedLayoutComponent = class SharedLayoutComponent {
};
...
module.exports = __webpack_require__(/*! C:\Users\lklam\OneDrive\Tài liệu\GitHub\websparks\src\main.ts */"./src/main.ts");
